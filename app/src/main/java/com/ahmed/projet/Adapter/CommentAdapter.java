...
import com.ahmed.projet.MainActivity;
import com.ahmed.projet.Model.Comment;
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (comment.getPublisher().endsWith(fUser.getUid())) {
                    ...
                    alertDialog.setTitle("Voulez-vous le supprimer ?");
                    alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "Non", new DialogInterface.OnClickListener() {
                        @Override
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Comments")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(mContext, "Commentaire supprimé avec succès!", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                    }
                                }
                            });
